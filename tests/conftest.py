...
def pytest_addoption(parser) -> None:
    ...
    parser.addoption("--iadir",       action="store",      default=crt_dir/'_IA',                      type=dir_path, help="Directory where the IA products will be generated. Don't forget to clean it eventually.")
    parser.addoption("--gamma_areadir",action="store",     default=crt_dir/'_GAMMA_AREA',              type=dir_path, help="Directory where the GAMMA_AREA products will be generated. Don't forget to clean it eventually.")
...
def pytest_generate_tests(metafunc) -> None:
    ...
    option_list = ['baselinedir', 'demdir', 'download', 'outputdir', 'tmpdir', 'liadir', 'iadir', 'gamma_areadir','eofdir', 'watch_ram', 'ram']
