...
// left corner of S1Tiling documentation
...
window.addEventListener('load', function() {
    ...
    if (window.location.hostname == "s1-tiling.pages.orfeo-toolbox.org") {
        versions_div_url = "https://s1-tiling.pages.orfeo-toolbox.org/s1tiling/develop/_static/html/versions.html";
    }
